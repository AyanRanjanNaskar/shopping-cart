...
export function Items({product, addToCart}) {
    ...
    return (
        <div className='flex flex-wrap gap-20 justify-center items-center bg-[#f4efca]' >
            {
                product.map((productItem, productIndex) =>{
                    return(
                        <div className='w-[17vw] shadow-2xl pl-6 pr-6 pt-8 rounded bg-white'>
                            ...
                            <button className='pt-2 pb-2 pl-2 pr-2 bg-[#f66435] text-[#f4efca] hover:bg-[#f64235] duration-200 rounded mb-4' onClick={() => addToCart(productItem)}>Add to Cart</button>
                        </div>
